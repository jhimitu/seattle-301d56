...
// "this" when joe.scope() is invoked is the instance of Student that was created and stored in the variable 'joe'.
// 2. What is "this" when joe.scopeArrow() is invoked?
// "this" when joe.scopeArrow() is invoked is the window object.
// 3. Explain why "this" is different when an arrow function is used.
// "this" is different when an arrow function is used because arrow functions do not bind "this". Due to this effect, the context of "this" defaults to the nearest function that does not use arrow functions, AKA the next-nearest enclosing scope.
